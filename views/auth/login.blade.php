...
<div class="container-md  mr-auto p-5 shadow p-5 mb-5 bg-dark rounded d-flex flex-column jusitify-content-center align-items-center ">
    ...
    <form method="post" action="/doLogin" autocomplete="off" class="border rounded p-5 sshadow-good">
        ...
        <div class="alert alert-danger m-1 p-3 {{ $errorLog!= "" ? "d-block" : "d-none" }} " 
            role="alert">@if($errorLog!="") {{$errorLog}} @endif</div>
        <div class="col text-center ">
            <a href="/register" class="align-self-center mt-5 py-2">هنوز عضو نشدم !</a>
        </div>
    </form>
